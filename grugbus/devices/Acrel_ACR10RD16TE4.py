...
def MakeRegisters():
    ...
    RegS32( 4, 253, 1, 'phase_1_active_power'         ,    1, 'W'  , 'float', 2, 'Phase 1 active power'         , ''),
    RegS32( 4, 255, 1, 'phase_2_active_power'         ,    1, 'W'  , 'float', 2, 'Phase 2 active power'         , ''),
    RegS32( 4, 257, 1, 'phase_3_active_power'         ,    1, 'W'  , 'float', 2, 'Phase 3 active power'         , ''),
    RegS32( 4, 259, 1, 'active_power'                 ,    1, 'W'  , 'float', 2, 'Active Power'                 , ''),
