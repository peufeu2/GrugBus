...
PLOTS = { p[1]:DataStream( *p ) for p in (
    ...
    ( 0, "chauffage/et_bureau"          , "et_bureau"           , "#800080"  , 1.0             , {} , False),
    ...
    ( 0, "chauffage/rc_pc_cuisine"      , "rc_cuisine"          , "#0000FF"  , 1.0             , {} , True ),
    ( 0, "chauffage/rc_pc_pcbt_ambient" , "rc_pcbt_ambient"     , "#00FF00"  , 1.0             , {} , True ),
    ( 0, "chauffage/rc_pc_pcbt_depart"  , "rc_pcbt_depart"      , "#00FF00"  , 1.0             , {} , False),
    ( 0, "chauffage/rc_pc_pcbt_retour"  , "rc_pcbt_retour"      , "#00FF00"  , 1.0             , {} , False),
    ( 0, "chauffage/rc_pf_pcbt_ambient" , "rc_pcbt2_ambient"    , "#0080FF"  , 1.0             , {} , True ),
    ( 0, "chauffage/rc_pf_pcbt_depart"  , "rc_pcbt2_depart"     , "#0080FF"  , 1.0             , {} , False),
    ( 0, "chauffage/rc_pf_pcbt_retour"  , "rc_pcbt2_retour"     , "#0080FF"  , 1.0             , {} , False),
    # ( 0, "chauffage/rc_pf_che"          , "rc_che"           , "#FF8000"  , 1.0             , {} , False),
